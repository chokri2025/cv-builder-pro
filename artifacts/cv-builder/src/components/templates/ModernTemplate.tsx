        ...
        {skills.length > 0 && (
          <div className="cv-modern-section">
            ...
            <div className="cv-modern-skills">
              {skills.map((s) => (
                <div key={s.id} className="cv-modern-skill-item">
                  {s.name}
                </div>
              ))}
            </div>
          ...
          <div className="cv-modern-section">
            ...
            {languages.map((l) => (
              <div key={l.id} className="cv-modern-lang">
                ...
                <span className="cv-modern-lang-level">
            ...
            {experience.map((exp) => (
              <div key={exp.id} className="cv-modern-exp-item">
                ...
                <div className="cv-modern-exp-content">
                  ...
                  {exp.company && (
                    <div className="cv-modern-exp-company">
                      {exp.company}
